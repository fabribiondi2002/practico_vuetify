...
export const useProductStore = defineStore('products', () => {
    const search = ref('');
    const drawer = ref(false); // Estado para el drawer de navegación principal
    const cart = ref(false);   // Estado para el drawer del carrito
    const products = ref([
    ...
    return { search, drawer, cart, products,productosFiltrados, carrito, itemsPerPage, paginatedProducts, page,agregarAlCarrito, actualizarStock, toggleDrawer, toggleCart };
});